...
{
    public class ProveYourLoveCampaignBehavior : CampaignBehaviorBase
    {
            ...
            {
            //
                return issueGiver.HasMet 
                && (Romance.GetRomanticLevel(Hero.MainHero, issueGiver) == Romance.RomanceLevelEnum.FailedInCompatibility 
                | Romance.GetRomanticLevel(Hero.MainHero, issueGiver) == Romance.RomanceLevelEnum.FailedInPracticalities);
            ...
            // Now the Issue
            internal class ProveYourLove : IssueBase
            {
